...
class TensorboardLogger:
    ...
    def __call__(self,train_loss: float, train_acc: float, val_loss: float, val_acc: float):
        """
...
class ModelCheckpoint:
    ...
    def save_checkpoint(self, model_state_dict: dict, opt_state_dict: dict, path: str):
    ...
    def __call__(self, model_state_dict:dict, opt_state_dict:dict, validation_acc:dict):
        self.epoch+=1
...
class CallbackExecuter:
    ...
    def execute(self, model_state_dict:dict, opt_state_dict:dict, train_loss:float, train_acc:float, val_loss:float, val_acc:float) -> bool:
        """
